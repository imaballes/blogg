...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'GET /dashboard' : 'PostController.dashboard',
  ...
  //post by id
  'GET /post/:id/edit' : 'PostController.getPost',
  'PUT /post/:id'      : 'PostController.editPost',
  'DELETE /post/:id'   : 'PostController.deletePost',
  
  //user by id
  'GET /user/:id/edit' : 'UserController.getUser',
